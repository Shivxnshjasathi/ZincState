        ...
        <div className="flex justify-between items-center h-16">
              ...
              <DropdownMenuContent className="w-80">
                <DropdownMenuItem>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      ZincState scales apps to meet user demand, automagically, based
                      on load.
                    </div>
                  </div>
                </DropdownMenuItem>
                ...
                <DropdownMenuItem>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      ZincState runs on Vercel, join us and others serving requests at
                      web scale.
                    </div>
                  </div>
                </DropdownMenuItem>
          ...
          <div className="flex items-center space-x-4">
            <Button asChild className="hidden sm:flex" size="sm">
              <Link href="https://www.linkedin.com/in/zinc-state-5b69b138a/" target="_blank">
                Connect on{" "}
                <svg
