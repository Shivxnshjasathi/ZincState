...
export const metadata: Metadata = {
  title: "ZincState - Foundational Software Solutions",
  description: "ZincState builds rock-solid custom software, web applications, and mobile apps that are secure, scalable, and designed for your business growth.",
};
